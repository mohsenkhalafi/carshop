...
if(isset($_POST['search']))
{
	...
	if(strlen($Search)>0)
	{
	$query = mysql_query("SELECT * FROM products where(title like '%".$Search."%' )")
or die(mysql_error());
	}
}
?>
                                        ...
                                        <div class="wrapper">
                                            <div class="grid_12">
                                            	<div class="indent-left">
                                                	<h3 class="p2" dir="rtl">نتایج جستجو</h3>
                                                    <div id="messageDIV" dir="rtl" align="right">
                                                    <?php
													if(isset($_POST['search']))
													{
															if(strlen($Search)>0)
														...
														while($row = mysql_fetch_array($query))
														{
															...
															echo '<li>'.'<time class="tdate-1" datetime="2011-08-15"><a class="link" href="show_product.php?ID='.$row['ID'].'">'.$row['title'].'</a></time></li>
															<p class="prev-indent-bot">'.$row['body'];
														}	
														if($i==0)
														{
